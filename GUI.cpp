...
void Boss_Menu(Fl_Widget* w, void* p)
{
	...
	if (name == "admin" && pass == "admin")
	{
		...
		Fl_Menu_Item menuitems[] =
		{
			...
			{ 0 },
			{ "&Save As",0,0,0, FL_SUBMENU },
			{ "Product Manager",0,(Fl_Callback*)SavePMCB },
			{ "Sales Associate",0,(Fl_Callback*)SaveSACB },
			{ "Customer",0,(Fl_Callback*)SaveCustCB },
			{ "Orders",0,(Fl_Callback*)SaveOrderCB },
			{ "Robots",0,(Fl_Callback*)SaveRobotCB },
			{ 0 },
